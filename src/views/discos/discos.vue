<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Discos'"
      :tituloBoton="'Crear Capacidad de Discos '"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestion de Capacidad de Discos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">

            <!--Traigo el componente llamado formModelos-->
          <FormDiscos
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="discos" label="Tipo de Discos" width="250" />
  ...
  import formDiscos from './components/formDiscos.vue';
import FormDiscos from './components/formDiscos.vue';
