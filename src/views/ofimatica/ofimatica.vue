<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Ofimática'"
      :tituloBoton="'Crear Nombres de Aplicativos de Ofimática'"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestión de Ofimática'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">

            <!--Traigo el componente llamado formulario de ofimática-->
          <formOfimatica
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="ofimatica" label="Nombres Aplicativos de Ofimática" width="300" />
  ...
  import formOfimatica from './components/formOfimatica.vue';
  ...
  const tableData = [
  {
    ofimatica: 'OFFICE PROFESSIONAL PLUS 2021 ',
  }
]
  </script>