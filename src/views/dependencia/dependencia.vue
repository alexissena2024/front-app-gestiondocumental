<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Dependencias'"
      :tituloBoton="'Crear Dependencias'"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestion de Dependencias'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="dependencia" label="Nombre de la Dependencia" width="250" />
