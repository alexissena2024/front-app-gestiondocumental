<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Memorias'"
      :tituloBoton="'Crear Capacidad de Memorias '"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestion de Memorias'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="memorias" label="Tipo de Memorias" width="250" />
  ...
  import FormMemorias from './components/formMemorias.vue';
