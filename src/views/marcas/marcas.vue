<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Marcas'"
      :tituloBoton="'Crear Marcas'"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestion de Marcas'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="marcas" label="Tipo de Marcas" width="250" />
  ...
  import FormMarcas from './components/formMarcas.vue';
