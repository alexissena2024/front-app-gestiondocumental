<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Sala de Sistemas'"
      :tituloBoton="'Crear Sala de Sistemas'"
      :abrir="abrirFormulario"
      />
      
       <!--Este formulario es el COMPONENTE**********************-->
      <Formulario :titulo="'Gestion de Sala de Sistemas'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="salaSistemas" label="Nombre de la Sala de Sistemas" width="250" />
...
import FormSalaSistemas from './components/formSalaSistemas.vue';
  ...
  const tableData = [
  {
    salaSistemas: 'SALA DE SISTEMAS 1',
  }
]
  </script>